...
public class Grid {
    ...
    private void drawGrid() {
        ...
        new Square(PADDING,PADDING,COLS*CELL_SIZE, ROWS*CELL_SIZE).getRECT().draw();
    }

    private void drawMovable(int x, int y) {
    ...
    public void paintErase() {
        ...
        if (!localSquare.isFilled() || localSquare.getColor() != color) {
